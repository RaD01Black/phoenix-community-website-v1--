! function(e, t) {
            ...
            return t.first ? function(t, n, i) {
                ...
                if (u) {
                    ...
                    while (t = t[r])
                        if (1 === t.nodeType || a)
                            if (f = t[b] || (t[b] = {}),
                                c = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                            else {
    ...
    function De(e, t, n, r, i, o) {
        ...
        if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ("string" == typeof n ? (i = r,
                r = void 0) : (i = r, r = n, n = void 0)), !1 === i) i = ke;
        else if (!i) return e;
    ...
    w.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (y && (u = y.events)) {
                l = (t = (t || "").match(M) || [""]).length;
                while (l--)
                    if (s = Ce.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(),
                        d) {
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (a = w.style(e, t)), !h.pixelBoxStyles() && We.test(a) && Be.test(t) && (r = s.width, i = s.minWidth,
    ...
    function ft(e, t) {
        var n, r, i, o, a;
        for (n in e)
            if (r = G(n), i = t[r], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]),
        ...
        validate: function(b) {
            ...
            return c ? c : (this.attr("novalidate", "novalidate"), c = new a.validator(b, this[0]),
                a.data(this[0], "validator", c), c.settings.onsubmit && (this.on("click.validate", ":submit", function(b) {
                    ...
                    function d() {
                        var d, e;
                        return c.submitButton && (c.settings.submitHandler || c.formSubmitted) && (d = a("<input type='hidden'/>").attr("name", c.submitButton.name).val(a(c.submitButton).val()).appendTo(c.currentForm)), !c.settings.submitHandler || (e = c.settings.submitHandler.call(c, c.currentForm, b),
                ...
                return a(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    return !d && b.settings.debug && window.console && console.error("%o has no name assigned", this),
                        this.hasAttribute("contenteditable") && (this.form = a(this).closest("form")[0],
                            this.name = d), !(d in c || !b.objectLength(a(this).rules())) && (c[d] = !0, !0);
                });
            },
            clean: function(b) {
                return a(b)[0];
...
! function(n) {
    ...
    (function(e) {
        ...
        function y(e) {
            v = a.window.innerWidth || document.documentElement.clientWidth, b = l ? (!m && document.body && ((m = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
                    document.body.appendChild(m)), (m ? m.clientHeight : 0) || a.window.innerHeight || document.documentElement.clientHeight) : a.window.innerHeight || document.documentElement.clientHeight,
                "object" !== (void 0 === e ? "undefined" : c(e)) || "load" !== e.type && "dom-loaded" !== e.type || (f = !0);
        }
        y(), a.window.addEventListener("resize", y), a.window.addEventListener("orientationchange", y),
            a.window.addEventListener("load", y), (0, n["default"])(function() {
                y({
                    type: "dom-loaded"
                });
            });
        ...
        var A = !!e.ResizeObserver && new e.ResizeObserver(function(e) {
            ...
            S = (t(j, [{
                ...
                value: function() {
                    ...
                    return t && "string" == typeof t && (t = e.$item.querySelector(t)), t instanceof Element || (e.options.imgSrc ? (t = new Image()).src = e.options.imgSrc : t = null),
                        t && (e.options.keepImg ? e.image.$item = t.cloneNode(!0) : (e.image.$item = t,
                            e.image.$itemParent = t.parentNode), e.image.useImgTag = !0), !(!e.image.$item && (null === e.image.src && (e.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                ...
                value: function() {
                    ...
                    if ("static" === e.css(e.$item, "position") && e.css(e.$item, {
                            ...
                            zIndex: 0
                        }), e.image.$container = document.createElement("div"), e.css(e.image.$container, t),
                        e.css(e.image.$container, {
                            "z-index": e.options.zIndex
                        }), u && e.css(e.image.$container, {
                            opacity: .9999
                        }), e.image.$container.setAttribute("id", "jarallax-container-" + e.instanceID),
                        e.$item.appendChild(e.image.$container), e.image.useImgTag ? n = e.extend({
                        ...
                        }, t, n))), "opacity" !== e.options.type && "scale" !== e.options.type && "scale-opacity" !== e.options.type && 1 !== e.options.speed || (e.image.position = "absolute"),
                        "fixed" === e.image.position)
                        for (var a = 0, r = e.$item; null !== r && r !== document && 0 === a;) {
                            var l = e.css(r, "-webkit-transform") || e.css(r, "-moz-transform") || e.css(r, "transform");
                            l && "none" !== l && (a = 1, e.image.position = "absolute"), r = r.parentNode;
                        }
                    n.position = e.image.position, e.css(e.image.$item, n), e.image.$container.appendChild(e.image.$item),
                        e.onResize(), e.onScroll(!0), e.options.automaticResize && A && A.observe(e.$item),
                        e.options.onInit && e.options.onInit.call(e), "none" !== e.css(e.$item, "background-image") && e.css(e.$item, {
                ...
                value: function() {
                    ...
                    if (e.$item.removeAttribute("data-jarallax-original-styles"), t ? e.$item.setAttribute("style", t) : e.$item.removeAttribute("style"),
                        e.image.useImgTag) {
                        var n = e.image.$item.getAttribute("data-jarallax-original-styles");
                        e.image.$item.removeAttribute("data-jarallax-original-styles"), n ? e.image.$item.setAttribute("style", t) : e.image.$item.removeAttribute("style"),
                            e.image.$itemParent && e.image.$itemParent.appendChild(e.image.$item);
                    }
                    e.$clipStyles && e.$clipStyles.parentNode.removeChild(e.$clipStyles), e.image.$container && e.image.$container.parentNode.removeChild(e.image.$container),
                ...
                value: function() {
                    var e = this,
                        ...
                        r = n,
                        l = 0;
                    return o && (i < 0 ? (a = i * Math.max(n, b), b < n && (a -= i * (n - b))) : a = i * (n + b),
                        1 < i ? r = Math.abs(a - b) : i < 0 ? r = a / i + Math.abs(a) : r += (b - n) * (1 - i),
                        a /= 2), e.parallaxScrollDistance = a, l = o ? (b - r) / 2 : (n - r) / 2, e.css(e.image.$item, {
                        height: r + "px",
                        marginTop: l + "px",
                ...
                value: function(e) {
                    ...
                    if (t.options.elementInViewport && (r = t.options.elementInViewport.getBoundingClientRect()),
                        ...
                        var l = Math.max(0, i),
                            ...
                            p = 1 - 2 * (b - i) / (b + o),
                            f = 1;
                        if (o < b ? f = 1 - (c || u) / o : s <= b ? f = s / b : d <= b && (f = d / b), "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (a.transform = "translate3d(0,0,0)",
                                a.opacity = f), "scale" === t.options.type || "scale-opacity" === t.options.type) {
                            var g = 1;
        ...
        function j(e, t) {
            ...
            if (Object.keys(i).forEach(function(e) {
                ...
                }), n.options = n.extend({}, n.defaults, o, t), n.pureOptions = n.extend({}, n.options),
                Object.keys(n.options).forEach(function(e) {
                    "true" === n.options[e] ? n.options[e] = !0 : "false" === n.options[e] && (n.options[e] = !1);
                }), n.options.speed = Math.min(2, Math.max(-1, parseFloat(n.options.speed))), "string" == typeof n.options.disableParallax && (n.options.disableParallax = new RegExp(n.options.disableParallax)),
    ...
    return (n = {}, s.m = i = [function(t, e, i) {
        ...
        var s = function() {
                ...
                return function(t, e, i) {
                    ...
                    key: "setViewportAll",
                    value: function() {
                        return this.positions.top = window.pageYOffset, this.positions.bottom = this.positions.top + this.positions.height,
            ...
            r = function() {
                for (var t, e = "transform webkitTransform mozTransform oTransform msTransform".split(" "), i = 0; void 0 === t;) t = void 0 !== document.createElement("div").style[e[i]] ? e[i] : void 0,
                    i += 1;
                return t;
            }(),
            a = function(t) {
        ...
        var h = function() {
            function i(t, e) {
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
                }(this, i), this.element = t, this.elementContainer = t, this.settings = e, this.isVisible = !0,
            ...
            return function(t, e, i) {
                ...
                value: function() {
                    this.isInit || this.element.closest(".simpleParallax") || (!1 === this.settings.overflow && this.wrapElement(this.element),
                        this.setStyle(), this.getElementOffset(), this.intersectionObserver(), this.getTranslateValue(),
                        this.animate(), this.isInit = !0);
                }
            }, {
                key: "wrapElement",
                value: function() {
                    ...
                    e.classList.add("simpleParallax"), e.style.overflow = "hidden", t.parentNode.insertBefore(e, t),
                ...
                value: function() {
                    ...
                    return t = Math.min(100, Math.max(0, t)), this.oldPercentage !== t && (this.rangeMax || this.getRangeMax(),
            ...
            b = function() {
                function i(t, e) {
                    ! function(t, e) {
                        ...
                        breakpoint: !1
                    }, this.settings = Object.assign(this.defaults, e), this.settings.breakpoint && document.documentElement.clientWidth <= this.settings.breakpoint || ("IntersectionObserver" in window || (g = !1),
                        this.lastPosition = -1, this.resizeIsDone = this.resizeIsDone.bind(this), this.handleResize = this.handleResize.bind(this),
                ...
                return function(t, e, i) {
                    ...
                    value: function() {
                        ...
                        f = y.length, v || (this.proceedRequestAnimationFrame(), window.addEventListener("resize", this.resizeIsDone),
                            v = !0);
                    }
                }, {
                    key: "resizeIsDone",
...
! function(n) {
    ...
    1199 < e && (n(document).on("mousemove", function(e) {
        ...
        return 0 == e.indexOf("#section-") ? (n("body").hasClass("home") || (location.href = "/" + e),
            n("body, html").animate({
                scrollTop: n(e).offset().top - 68
            }, 400), n("header").hasClass("active") && n(".menu-btn").trigger("click")) : (n(".lines").removeClass("finish"),
            n(".lines").removeClass("ready"), n(".lines").addClass("no-lines"), setTimeout(function() {
                location.href = "" + e;
            }, 2500)), !1;
        ...
        n(this).scrollTop() >= n(".section.started").height() ? n("body").removeClass("background-enabled") : !n("header").hasClass("active") && n(".video-bg").length && n("body").addClass("background-enabled"),
            100 <= n(this).scrollTop() && 1 < n(".section").length && (n(".header").addClass("fixed"),
                n(".footer").addClass("fixed"), n(".mouse_btn").fadeOut()), n(this).scrollTop() <= 100 && 1 < n(".section").length && (n(".header").removeClass("fixed"),
                n(".footer").removeClass("fixed"), n(".mouse_btn").fadeIn());
    }), n("header").on("click", ".menu-btn", function() {
        return n("header").hasClass("active") ? (n("header").removeClass("active"), n(".footer .soc").fadeIn(),
            n("body").addClass("loaded"), n(".video-bg").length && n("body").addClass("background-enabled")) : (n("header").addClass("active"),
            n(".footer .soc").hide(), n("body").removeClass("loaded"), n("body").removeClass("background-enabled")), !1;
    ...
    var s = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
        i = !1;
    /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) && (i = !0),
        n(".video-bg").length && (n("body").addClass("background-enabled"), i ? n(".video-mobile-bg").each(function() {
            ...
            n(".top-menu ul li a").each(function() {
                if (0 == n(this).attr("href").indexOf("#section-")) {
                    var e = n(this),
                        a = n(e.attr("href"));
                    a.length && a.offset().top <= t + 70 && (n(".top-menu ul li").removeClass("current-menu-item"),
                        e.closest("li").addClass("current-menu-item")), 0 == t && n(".top-menu ul li").removeClass("current-menu-item");
                }
            });
            ...
            var e = n(".skills.dotted .progress"),
                a = e.width();
            e.length && (e.append('<span class="dg"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></span>'),
